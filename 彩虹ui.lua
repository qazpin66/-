...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/qazpin66/-/refs/heads/main/%E5%BD%A9%E8%99%B9ui.lua"))()
local window = library:new("鹤脚本")

local creds = Window:Tab("公告",'16060333448')
local bin = creds:section("信息",true)

local Qum = Window:Tab("功能",'16060333448')
local Soo = Qum:section("1",true)
...
bin:Label("")
bin:Label("")
bin:Button("复制", function()
    setclipboard("36")
end)
bin:Button("复制", function()
    setclipboard("37")
end)
bin:Toggle("移除UI辉光", "DHG", false, function(DHG)
    if DHG then
...
bin:Toggle("彩虹UI", "RBUI", false, function(RBUI)
    if RBUI then
...
bin:Button("摧毁界面", function()
    game:GetService("CoreGui")["frosty is cute"]:Destroy()
end)

Soo:Button("实验功能", function()
    loadstring(game:HttpGet("https://pastebin.com/raw/FGjjwm6W"))()
end)

local Dcc = Window:Tab("功能",'16060333448')
local Qoo = Dcc:section("通用",true)

Qoo:Button("禁漫", function()
