...
local Window = OrionLib:MakeWindow({Name = "YSX脚本", HidePremium = false, IntroText = "YXS脚本"})
...
Tab:AddButton({
	Name = "巴掌脚本",
	Callback = function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/XT114514/rbx/main/FreeGetGlove"))()
end
})
