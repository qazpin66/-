...
local abouti = Window:MakeTab({
    Name = "公告",
    Icon = "rbxassetid://4483345998",
    PremiumOnly = false
})

abouti:AddParagraph("该脚本免费")
abouti:AddParagraph("作者:月双喜")
abouti:AddParagraph("师傅：鹤")
abouti:AddParagraph("禁止倒卖")
abouti:AddParagraph("每天优化更新")
abouti:AddParagraph("更新日志：null")
abouti:AddParagraph("感谢支持")
